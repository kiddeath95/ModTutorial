package net.sloth.mccourse.block;
...
import net.sloth.mccourse.MCCourseMod;
import net.sloth.mccourse.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> RAW_ALEXANDRITE_BLOCK = registerBlock("raw_alexandrite_block",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.RAW_IRON_BLOCK).strength(5f)));
